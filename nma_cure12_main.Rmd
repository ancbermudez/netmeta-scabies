...
### By one week (code: sg_outcometime = 1)
```{r, echo = FALSE}
cure.nmeta.time1 <- netmeta(TE = ycorr,
                            seTE = stderr,
                            treat1 = t1_lab,
                            treat2 = t2_lab,
                            studlab = study,
...
### By two weeks (code: sg_outcometime = 2)
```{r, echo = FALSE}
cure.nmeta.time2 <- netmeta(TE = ycorr,
                            seTE = stderr,
                            treat1 = t1_lab,
                            treat2 = t2_lab,
                            studlab = study,
...
fp.time <- netbind(cure.nmeta.time1, cure.nmeta.time2, 
                   name = c("By one week", "By two weeks"),
                   col.study = c("red", "black"),
                   col.square = c("red", "black"))
...
### Mixed-effects meta-regression
```{r, echo = FALSE}
reg.time <- rma(yi = y, sei = stderr, mods = as.factor(sg_outcometime), data = cure_pairs, 
                method = "REML", test = "knha")
reg.time
```
...
### Sample size per subgroup
```{r, echo = FALSE}
with(cure_long, sum(n[sg_outcometime == 1]))
with(cure_long, sum(n[sg_outcometime == 2]))
```

## *By climate*

### By climate = 1 (code: ph_sg_climat = 1)
```{r, echo = FALSE}
cure.nmeta.clim1 <- netmeta(TE = ycorr,
                            seTE = stderr,
                            treat1 = t1_lab,
                            treat2 = t2_lab,
                            studlab = study,
...
### By climate = 2 (code: ph_sg_climat = 2)
Cannot fit model since the network consists of two separate sub-networks
```{r, echo = FALSE, eval = FALSE}
cure.nmeta.clim2 <- netmeta(TE = ycorr,
                            seTE = stderr,
                            treat1 = t1_lab,
                            treat2 = t2_lab,
                            studlab = study,
...
### By climate = 3 (code: ph_sg_climat = 3)
```{r, echo = FALSE}
cure.nmeta.clim3 <- netmeta(TE = ycorr,
                            seTE = stderr,
                            treat1 = t1_lab,
                            treat2 = t2_lab,
                            studlab = study,
...
### Combined forest plot
```{r, echo = FALSE, fig.height = 6}
fp.clim <- netbind(cure.nmeta.clim1, cure.nmeta.clim3, 
...
### Mixed-effects meta-regression
```{r, echo = FALSE}
reg.clim <- rma(yi = y, sei = stderr, mods = as.factor(ph_sg_climat), data = cure_pairs, 
                method = "REML", test = "knha")
reg.clim
```
...
### Sample size per subgroup
```{r, echo = FALSE}
with(cure_long, sum(n[ph_sg_climat == 1]))
with(cure_long, sum(n[ph_sg_climat == 2]))
with(cure_long, sum(n[ph_sg_climat == 3]))
```
